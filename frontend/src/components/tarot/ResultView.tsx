'use client'
// ============================================================
// ResultView.tsx — 占卜結果展示（優化布局，充分利用空間）
// 根據牌數自動調整：單卡超大居中，多牌緊湊排列
// ============================================================
    ...
    <div className="w-full max-w-4xl mx-auto px-4 pb-12 space-y-5">
          ...
          <div className="flex gap-3 overflow-x-auto pb-2">
            {drawnCards.map((drawn, i) => {
              ...
              return (
                <div
                  key={i}
                  className="glass-card rounded-xl p-2.5 flex gap-3 items-center flex-shrink-0"
                  style={{ minWidth: 180 }}
                >
                  {/* 縮圖 */}
                  <div
      ...
      >
        ...
        {isLoadingInterpret ? (
          ...
          <div
            className="text-white/85 leading-8 text-base whitespace-pre-wrap"
